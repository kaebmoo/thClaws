...
- **Media, end to end** — Media Studio generates images and video (Gemini, OpenAI `gpt-image-2.5`, Qwen, Veo, LTX, iApp for Thai text) from a point-and-click shell or from chat; **Movie Maker** takes a screenplay through shots to a finished film.
